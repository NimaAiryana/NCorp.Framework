...
namespace NCorp.Framework.Exceptions.Types
{
    ...
    {
        public InvalidFileSizeException() : base("File size is out of range!") { }
        public InvalidFileSizeException(Exception innerException) : base("File size is out of range!", innerException) { }
